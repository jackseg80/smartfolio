"""
Quick test script for Stop Loss Backtesting

Usage:
    python -m services.ml.bourse.test_backtest

Tests ATR 2x vs Fixed % on 3 representative assets:
- AAPL (moderate volatility)
- NVDA (high volatility)
- SPY (low volatility ETF)
"""
...
def main():
    ...
    print(f"  2. If ATR performs better, proceed to Phase 2 (Support Detection)")
    print(f"  3. If results are mixed, investigate specific scenarios")
    print(f"  4. Generate HTML report: python -m services.ml.bourse.generate_backtest_report")


if __name__ == "__main__":
    # Import numpy for JSON conversion
    import numpy as np
